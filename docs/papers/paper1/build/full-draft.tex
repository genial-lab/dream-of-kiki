...
\newenvironment{CSLReferences}[2] % #1 hanging-indent, #2 entry-spacing
 ...
 {\end{list}}
% \usepackage{calc} — already loaded above (see line 41); duplicate removed
...
suites are available at \texttt{github.com/hypneum-lab/dream-of-kiki}.
...
under 9 axiom-property and invariant-enforcement tests each (\textasciitilde27
assertions total: 18 substrate-paired tests \texttimes{} an average of 1.5
underlying \texttt{assert} statements per test). The criterion is therefore non-vacuous in the minimal
...
A sibling project at \texttt{github.com/hypneum-lab/nerve-wml} (same
